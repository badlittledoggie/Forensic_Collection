...
%c_drive%:\IR_Tools\IR_tools\sysinternals\tcpvcon.exe -can -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\tcpvcon-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\sysinternals\psloggedon.exe -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\psloggedon-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\sysinternals\pslist.exe -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\pslist-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\sysinternals\psfile.exe -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\psfile-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\sysinternals\psinfo.exe -d -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\psinfo-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\sysinternals\autorunsc.exe -a -c -accepteula >> %c_drive%:\Data-%COMPUTERNAME%\volatile_data\autoruns-%COMPUTERNAME%.csv
%c_drive%:\IR_tools\IR_tools\nirsoft\cprocess.exe /stab %c_drive%:\Data-%COMPUTERNAME%\volatile_data\cprocess-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\nirsoft\cports.exe /stab %c_drive%:\Data-%COMPUTERNAME%\volatile_data\cports-%COMPUTERNAME%.txt
%c_drive%:\IR_tools\IR_tools\winaudit\WinAudit.exe /r=gsoPxuTUeERNtnzDaIbMpmidcSArGBL /o=HTML /f=%c_drive%:\Data-%COMPUTERNAME%\volatile_data\winaudit-
